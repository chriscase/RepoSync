...
cp scripts/reliability-prep.py scripts/reliability-runtime.py scripts/reliability_scan.py "$base_context/scripts/"
...
cp scripts/reliability-prep.py scripts/reliability-runtime.py scripts/reliability_scan.py "$previous_context/scripts/"
